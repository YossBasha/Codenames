...
export declare function rankCardsForOperative(clue: string, cards: import("../../../shared/types").Card[], team: import("../../../shared/types").Team, language: string, isDuet: boolean): import("../../../shared/types").Card[];
